...
int main(int argc, char **argv) {
    ...
    light_shader.set_vecf3("point_light_radiance", { 135, 206, 235 });
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        light_shader.set_matf4("projection", camera.get_projection_matrix((float)SCR_WIDTH, (float)SCR_HEIGHT, 0.1f, 100.0f));
